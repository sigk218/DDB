...
export const GET_HOS_BY_STAR = 'GET_HOS_BY_STAR'
export const GET_HOS_BY_REVIEW = 'GET_HOS_BY_REVIEW'
export const SET_NEAR_HOS_STATUS = 'SET_NEAR_HOS_STATUS'
export const SET_NEAR_HOS_BY_STAR_STATUS = 'SET_NEAR_HOS_BY_STAR_STATUS'
export const SET_NEAR_HOS_BY_REVIEW_STATUS = 'SET_NEAR_HOS_BY_REVIEW_STATUS'
export const SET_HOS_BY_WORD_STATUS = 'SET_HOS_BY_WORD_STATUS'
export const SET_HOS_BY_STAR_STATUS = 'SET_HOS_BY_STAR_STATUS'
export const SET_HOS_BY_REVIEW_STATUS = 'SET_HOS_BY_REVIEW_STATUS'
